...
RSpec.describe GroupMembershipsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all group_memberships as @group_memberships" do
      ...
      expect(assigns(:group_memberships)).to eq([group_membership])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested group_membership as @group_membership" do
      ...
      expect(assigns(:group_membership)).to eq(group_membership)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new group_membership as @group_membership" do
      ...
      expect(assigns(:group_membership)).to be_a_new(GroupMembership)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created group_membership as @group_membership" do
        post :create, {:group_membership => valid_attributes}, valid_session
        expect(assigns(:group_membership)).to be_a(GroupMembership)
        expect(assigns(:group_membership)).to be_persisted
      end

      it "redirects to the created group_membership" do
        post :create, {:group_membership => valid_attributes}, valid_session
        expect(response).to redirect_to(GroupMembership.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved group_membership as @group_membership" do
        post :create, {:group_membership => invalid_attributes}, valid_session
        expect(assigns(:group_membership)).to be_a_new(GroupMembership)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested group_membership" do
        group_membership = GroupMembership.create! valid_attributes
        put :update, {:id => group_membership.to_param, :group_membership => new_attributes}, valid_session
      ...
      it "redirects to the group_membership" do
        group_membership = GroupMembership.create! valid_attributes
        put :update, {:id => group_membership.to_param, :group_membership => valid_attributes}, valid_session
        expect(response).to redirect_to(group_membership)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the group_membership as @group_membership" do
        group_membership = GroupMembership.create! valid_attributes
        put :update, {:id => group_membership.to_param, :group_membership => invalid_attributes}, valid_session
        expect(assigns(:group_membership)).to eq(group_membership)
      end
