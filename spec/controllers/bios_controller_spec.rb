  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created bio as @bio" do
        post :create, {:bio => valid_attributes}, valid_session
        expect(assigns(:bio)).to be_a(Bio)
        expect(assigns(:bio)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved bio as @bio" do
        post :create, {:bio => invalid_attributes}, valid_session
        expect(assigns(:bio)).to be_a_new(Bio)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bio" do
        bio = Bio.create! valid_attributes
        put :update, {:id => bio.to_param, :bio => new_attributes}, valid_session
        bio.reload
    ...
    context "with invalid params" do
      it "assigns the bio as @bio" do
        bio = Bio.create! valid_attributes
        put :update, {:id => bio.to_param, :bio => invalid_attributes}, valid_session
        expect(assigns(:bio)).to eq(bio)
      end
